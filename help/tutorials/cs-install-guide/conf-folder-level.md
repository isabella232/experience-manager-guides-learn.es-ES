...
1. Para definir las reglas de traducción, examine la ubicación de SRX para encontrar la carpeta que contiene los archivos SRX. El formato SRX \(Intercambio de reglas de segmentación\) es un estándar para intercambiar reglas de segmentación entre distintos usuarios y entornos de traducción. Puede crear una carpeta y agregarle los archivos SRX personalizados.
   ...
   Una vez creada la carpeta que contiene los archivos SRX, puede añadir la ruta de la carpeta en la **Ubicación de SRX de traducción** configuración dentro del perfil de carpeta.
...
1. Realice una de las siguientes acciones para crear o editar un ajuste preestablecido de salida:
   ...
   - Clic **Editar** para abrir la configuración del ajuste preestablecido seleccionado y editarlo.
     ...
     Para obtener información sobre los ajustes preestablecidos de salida, consulte *Explicación de los ajustes preestablecidos de salida* en la guía as a Cloud Service Uso de guías de Adobe Experience Manager.
...
Esta opción controla la barra de herramientas y los demás elementos de interfaz de usuario del Editor Web. Haga clic en el icono Descargar para descargar el archivo ui\_config.json en su sistema local. A continuación, puede realizar cambios en el archivo y cargarlo. Dependiendo de dónde cargue el archivo en el perfil global o de nivel de carpeta, los cambios se aplicarán en consecuencia. Para obtener más información sobre cómo personalizar el Editor XML mediante el archivo ui\_config.json, consulte [Personalizar barra de herramientas](conf-web-editor-customize-toolbar.md#).
...
description: Añada información descriptiva para el fragmento.
