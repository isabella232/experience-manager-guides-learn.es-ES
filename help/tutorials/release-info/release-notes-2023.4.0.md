...
3. Confirme los cambios y ejecute la canalización de Cloud Services AEM para actualizar a la versión de abril de 2023 de las guías de la as a Cloud Service.
