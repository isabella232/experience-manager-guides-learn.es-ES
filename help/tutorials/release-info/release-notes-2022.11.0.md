...
2. Actualizar `<dox.version>` propiedad en `/dox/dox.installer/pom.xml` de su código Git de Cloud Services a 2022.11.198.
3. Confirme los cambios y ejecute la canalización de Cloud Services AEM para actualizar a la versión de noviembre de las guías de los usuarios as a Cloud Service de la versión de noviembre de la versión de las guías de los usuarios de la aplicación de.
...
**Nota**: también puede eliminar el archivo seleccionado utilizando la tecla Supr del teclado.
