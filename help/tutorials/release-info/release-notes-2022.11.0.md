...
description: Versión de noviembre de las guías de Adobe Experience Manager as a Cloud Service
...
# Versión de noviembre de las guías de Adobe Experience Manager as a Cloud Service
...
1. Actualizar `<dox.version>` propiedad en `/dox/dox.installer/pom.xml` del código Git de sus Cloud Services a 2022.11.198.
1. Confirme los cambios y ejecute la canalización de Cloud Services para actualizar a la versión de noviembre de AEM Guías as a Cloud Service.
...
AEM guías as a Cloud Service proporciona mejoras y nuevas funciones en la versión de noviembre:
