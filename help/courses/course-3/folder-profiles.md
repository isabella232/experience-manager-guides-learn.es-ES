...
4. Seleccione el perfil que desee. Por ejemplo, elija **Perfil global**, que es el perfil predeterminado.
...
2. Haga clic en [!UICONTROL **Editar**] en la esquina superior izquierda de la pantalla.

   ![Atributos condicionales](images/lesson-3/edit-conditional-attributes.png)

3. Haga clic en [!UICONTROL **Agregar**].

4. Rellene el **Nombre**, **Valor** y **Etiqueta** para la nueva condición.

   ![nueva condición](images/lesson-3/new-condition.png)

5. Haga clic en [!UICONTROL **Guardar**] en la esquina superior izquierda de la pantalla.
...
5. En el cuadro de diálogo Crear perfil de carpeta .
...
2. Seleccione el **General** pestaña .

3. Haga clic en [!UICONTROL **Editar**] en la parte superior izquierda de la pantalla.

4. En Usuarios administradores, seleccione un usuario de la lista desplegable o escriba el nombre de un usuario.
...
6. Haga clic en [!UICONTROL **Guardar**] en la esquina superior derecha de la pantalla cuando se han agregado todos los usuarios.
...
2. Haga clic en Editar en la esquina superior izquierda de la pantalla.

3. Agregar una plantilla de mapa.
...
4. Agregar una plantilla de tema.
...
6. Agregue plantillas de tema adicionales según sea necesario.

7. Cuando termine, haga clic en [!UICONTROL **Guardar**] en la parte superior izquierda de la pantalla.
...
2. En el panel izquierdo, seleccione las casillas de verificación de los ajustes preestablecidos que no sean necesarios.

   ![Eliminar ajustes preestablecidos](images/lesson-3/delete-presets.png)

3. Haga clic en [!UICONTROL **Eliminar ajuste preestablecido**] en la esquina superior izquierda de la pantalla.

4. En el cuadro de diálogo Eliminar ajuste preestablecido, haga clic en [!UICONTROL **Eliminar**].
...
2. En Fragmentos del Editor XML, haga clic en [!UICONTROL **Cargar**].

   ![Cargar fragmento de código](images/lesson-3/upload-snippet.png)

3. Vaya a un fragmento creado anteriormente.

4. Haga clic en [!UICONTROL **Apertura**].

5. Haga clic en [!UICONTROL **Guardar**] en la parte superior izquierda de la pantalla.
...
2. Haga clic en la carpeta del contenido con el que desea trabajar.

3. Haga clic en el [!UICONTROL **Preferencias de usuario**] en la barra de herramientas superior.

   ![Preferencias de usuario](images/lesson-3/hr-user-prefs.png)

4. En el cuadro de diálogo Preferencias de usuario, seleccione el perfil de carpeta que desee en la lista desplegable.
